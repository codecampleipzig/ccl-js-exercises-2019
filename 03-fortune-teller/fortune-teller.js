...
// Compile Message
var message = `Those born under the planetary sign of the ${random(noun)} possess ${random(adjective)} personalities and are forever searching for new ${random(pluralNoun)} to conquer.`;
