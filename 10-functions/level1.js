...
// Exercise 6
// Create a function that finds the maximum *integer* range of a triangle's third edge.
// Examples
//    nextEdge(8, 10) ➞ 17
//    nextEdge(5, 7) ➞ 11
//    nextEdge(9, 2) ➞ 10
...
function totalLegs(a, b, c) {
   return (chicken * a) + (cow * b) + (pig * c);
}
...
function profitableGamble(prob, prize, cost) {
   if (prob * prize > cost) {
      return "true";
   }
   else {
