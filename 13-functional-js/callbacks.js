...
testEqual ("compareNumbers", compareNumbers(3, 1), 1)
testEqual ("compareNumbers", compareNumbers(1, 3), -1)
testEqual ("compareNumbers", compareNumbers(3, 3), 0)
...
// Write a function sortNumberArray, which takes an array of numbers and returns a sorted version of the array. 
//It's ok if the function mutates the input array.
// Note:
...
// Exercise 3
// Create a function which takes an array of strings and returns a new array, which contains the same strings, but in uppercase. 
// But don't use a loop.
...
function arrayToUpperCase(stringsArray) {
   return stringsArray.map(stringsToUpperCase);
}

testEqual ("stringsToUpperCase", arrayToUpperCase(["ab", "bc", "cd"]), ["AB", "BC", "CD"]);
